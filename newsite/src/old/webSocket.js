...
try {
  tempWst = new WebSocket("ws://" + location.host + "/ws");
} catch {
  try {
    tempWst = new WebSocket("wss://chat-8518.onrender.com/" + "/ws");
  } catch {
    tempWst = new WebSocket("wss://elchat.netlify.app/" + "/ws");
  }
}
 ...
 * @returns {string} The sent pseudo
 */
